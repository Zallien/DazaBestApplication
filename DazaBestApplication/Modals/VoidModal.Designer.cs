namespace DazaBestApplication.Modals
{
    partial class VoidModal
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VoidModal));
            ...
            bunifuImageButton1.Location = new Point(307, 3);
            ...
            label1.TabIndex = 3;
            label1.Text = "Reason of Cancellation or Voiding the Order ?";
            // 
            // voiddetailstxt
            // 
            voiddetailstxt.Font = new Font("Courier New", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            voiddetailstxt.Location = new Point(12, 94);
            voiddetailstxt.Multiline = true;
            voiddetailstxt.Name = "voiddetailstxt";
            voiddetailstxt.Size = new Size(316, 69);
            voiddetailstxt.TabIndex = 4;
            voiddetailstxt.TextChanged += voiddetailstxt_TextChanged;
            voiddetailstxt.KeyPress += voiddetailstxt_KeyPress;
            // 
            // bunifuButton1
            // 
            ...
            bunifuButton1.Location = new Point(223, 169);
            ...
            // textcount
            // 
            textcount.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            textcount.AutoSize = true;
            textcount.Location = new Point(293, 74);
            textcount.Name = "textcount";
            textcount.Size = new Size(35, 15);
            textcount.TabIndex = 6;
            textcount.Text = "0/50";
            // 
            // VoidModal
            // 
        ...
        private TextBox voiddetailstxt;
